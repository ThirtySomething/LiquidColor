...
export class StrategyMinimax {
    ...
    chooseColor(input) {
        ...
        for (const compColor of allColors) {
            ...
            const { gained: compGain, newOwnedSet: compOwned2 } = CaptureSimulator.simulate(cells, definitions, compOwned, humanOwned, compColor);
            ...
            for (const humanColor of allColors) {
                ...
                const { gained: humanGain } = CaptureSimulator.simulate(cells, definitions, humanOwned, compOwned2, humanColor);
