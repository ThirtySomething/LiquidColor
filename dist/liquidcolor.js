...
${codeFrame}` : message);
  ...
  // definitions.ts
  var _Definitions = class _Definitions {
    ...
    static initialize(dimX, dimY, cellSize) {
      if (!_Definitions.instance) {
        _Definitions.instance = new _Definitions(dimX, dimY, cellSize);
      } else {
        _Definitions.instance.reInit(dimX, dimY, cellSize);
      }
    }
    static getInstance() {
      if (!_Definitions.instance) {
  ...
  __publicField(_Definitions, "instance", null);
  ...
  // highscore.ts
  var _Highscore = class _Highscore {
    constructor() {
    ...
    load() {
      ...
      try {
        const raw = window.localStorage.getItem(_Highscore.STORAGE_KEY);
        if (!raw) {
          return fallback;
        }
    ...
    save() {
      window.localStorage.setItem(_Highscore.STORAGE_KEY, JSON.stringify(this.m_Data));
    }
  };
  __publicField(_Highscore, "STORAGE_KEY", "liquidcolor-highscore-v1");
  var Highscore = _Highscore;
  ...
  var Player = class {
    ...
    cellsMarkOwner(cells, definitions2, canvasElement) {
      ...
      do {
        ...
        cellsWork = cellsCollect.filter((value, index, self2) => self2.indexOf(value) === index);
        cellsCollect = [];
  ...
  var CommandPlayColor = class {
    constructor(board2, color) {
  ...
  var _Board = class _Board {
    constructor(definitions2, playerHuman, playerComputer) {
      ...
      __publicField(this, "m_Highscore");
      __publicField(this, "m_UISubject");
      __publicField(this, "m_CommandInvoker");
    ...
    static initialize(definitions2, playerHuman, playerComputer) {
      if (!_Board.instance) {
        _Board.instance = new _Board(definitions2, playerHuman, playerComputer);
      }
    }
    static getInstance() {
      if (!_Board.instance) {
  ...
  __publicField(_Board, "instance", null);
  var Board2 = _Board;

  // commands/commandresetgame.ts
  var CommandResetGame = class {
    constructor(board2, idDimX, idDimY, idCellSize, idPlayerName, idComputerStrategy) {
      __publicField(this, "board");
      __publicField(this, "idDimX");
      __publicField(this, "idDimY");
      __publicField(this, "idCellSize");
      __publicField(this, "idPlayerName");
      __publicField(this, "idComputerStrategy");
      this.board = board2;
      this.idDimX = idDimX;
      this.idDimY = idDimY;
  ...
  var definitions = Definitions.getInstance();
  var human = new Player("Besucher", "name_human", "score_human", () => {
  });
  var computer = new Player("DerPaul", "name_computer", "score_computer", () => {
  });
  Board2.initialize(definitions, human, computer);
  var board = Board2.getInstance();
  ...
  createApp({
    methods: {
      resetGame() {
        ...
        Board2.getInstance().getCommandInvoker().execute(command);
      }
    },
    mounted() {
      Board2.getInstance().init("gamearea", "playbuttons", "winner");
    },
    template: `
...
vue/dist/vue.esm-bundler.js:
  ...
  **)
*/
//# sourceMappingURL=liquidcolor.js.map
